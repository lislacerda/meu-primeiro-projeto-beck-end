...
const conectaBancoDeDados = require('./bancoDeDados') //aqui estou ligando ao arquivo conectaBancoDeDados
conectaBancoDeDados() //estou chamando a função que conecta o banco de dados

const Mulher = require('./mulherModel')

const app = express() //aqui estou iiciando o app
...
app.use(router.post("/mulheres", criaMulher)) //configurei rota POST /muleres
app.unsubscribe(router.patch("/mulheres/:id", corrigeMulher)) // configureirota PATCH / MULHERES
